...
static const EIF_TYPE_INDEX egt_1_1023 [] = {0xFF01,240,1022,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_1023 [] = {0xFF01,1017,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1023 [] = {0xFF01,220,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1023 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_1023[] = {
	...
	{EIF_GENERIC(egt_9_1023), 14880, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1023), 14876, 0},
	{EIF_GENERIC(egt_14_1023), 14877, 8},
	{EIF_GENERIC(egt_15_1023), 14878, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_1023), 14879, 0xFFFFFFFF},
};
void Init1023(void)
{
	IDSC(desc_1023, 0, 1022);
	IDSC(desc_1023 + 1, 1, 1022);
	IDSC(desc_1023 + 32, 408, 1022);
	IDSC(desc_1023 + 35, 401, 1022);
}
