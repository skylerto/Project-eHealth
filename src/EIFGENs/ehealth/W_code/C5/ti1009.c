...
EIF_TYPED_VALUE F1009_9183 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(7036,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F1009_9184 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(7037,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F1009_9185 (EIF_REFERENCE Current)
{
	...
	Result = *(EIF_REAL_64 *)(Current + RTWA(7036, dtype));
...
EIF_TYPED_VALUE F1009_9186 (EIF_REFERENCE Current)
{
	...
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(7036, Dtype(Current)));
...
body:;
	...
	ui4_1 = ti4_3;
	ti4_2 = eif_bit_and(ti4_1,ui4_1);
	*(EIF_INTEGER_32 *)(Current + RTWA(7037, dtype)) = (EIF_INTEGER_32) ti4_2;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7037, 0x10000000, 1); /* compact_time */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7037, dtype));
...
body:;
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7036, 0x20000000, 1); /* fractional_second */
	*(EIF_REAL_64 *)(Current + RTWA(7036, dtype)) = (EIF_REAL_64) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
