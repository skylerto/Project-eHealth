...
extern EIF_TYPED_VALUE F1053_9510(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1053_9511(EIF_REFERENCE);
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 1052, Current, 3, 0, 15045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1052, Current, 15045);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ur1 = tr1;
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7287, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
	tb1 = '\0';
	...
	if (tb1) {
		...
		ur1 = tr1;
		loc3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7287, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTHOOK(6);
		tb1 = '\0';
		...
		if (tb1) {
			...
			loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7286, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTHOOK(9);
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 1052, Current, 2, 0, 15046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1052, Current, 15046);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 2, 0xF80000DC, 0, 0); /* loc2 */
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 1052, Current, 1, 0, 15047);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1052, Current, 15047);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1052, Current, 0, 0, 15048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1052, Current, 15048);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1053_9510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1052, Current, 0, 1, 15049);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1052, Current, 15049);
...
RTOID (F1053_9511)
EIF_TYPED_VALUE F1053_9511 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1052, Current, 0, 0, 15050);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1052, Current, 15050);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (9506,F1053_9506)
	RTOTS (9507,F1053_9507)
	RTOTS (9508,F1053_9508)
	RTOTS (9511,F1053_9511)
}
