...
void F879_8230 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6160, 0x04000000, 1); /* is_utc */
	*(EIF_BOOLEAN *)(Current + RTWA(6160, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(2);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTHOOK(3);
	up1 = loc1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6169, dtype))(Current, up1x);
	RTHOOK(4);
	up1 = loc1;
	up2 = loc3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(6174, dtype))(Current, up1x, up2x);
	RTHOOK(5);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(6160, dtype));
	if (tb1) {
		RTHOOK(6);
		...
		up1 = loc3;
		loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6177, dtype))(Current, up1x)).it_p);
	} else {
		RTHOOK(7);
		RTDBGAL(Current, 2, 0x40000000, 1, 0); /* loc2 */
		up1 = loc3;
	...
	RTHOOK(8);
	RTDBGAA(Current, dtype, 6175, 0xF8000097, 0); /* internal_item */
	tr1 = RTLNSMART(RTWCT(6175, dtype, Dftype(Current)).id);
	up1 = loc2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6172, dtype))(Current)).it_i4);
	ui4_1 = ti4_1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(6175, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	up1 = loc1;
	loc4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6173, dtype))(Current, up1x)).it_i4);
	RTHOOK(10);
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (loc4 < ((EIF_INTEGER_32) 0L)) || (EIF_BOOLEAN) (loc4 > ((EIF_INTEGER_32) 999L)))) {
		RTHOOK(11);
		RTDBGAA(Current, dtype, 6168, 0x10000000, 1); /* millisecond_now */
		*(EIF_INTEGER_32 *)(Current + RTWA(6168, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	} else {
		RTHOOK(12);
		RTDBGAA(Current, dtype, 6168, 0x10000000, 1); /* millisecond_now */
		*(EIF_INTEGER_32 *)(Current + RTWA(6168, dtype)) = (EIF_INTEGER_32) loc4;
	}
	RTHOOK(13);
	free(loc1);
	RTHOOK(14);
...
#define up1 up1x.it_p
	...
	tp1 = *(EIF_POINTER *)(tr1 + RTVA(2675, "item", tr1));
	up1 = tp1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6183, dtype))(Current, up1x)).it_i4);
	RTHOOK(2);
...
EIF_TYPED_VALUE F879_8240 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(6168,Dtype(Current)));
	return r;
}
