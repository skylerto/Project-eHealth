...
static const EIF_TYPE_INDEX egt_1_881 [] = {0xFF01,240,880,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_881 [] = {0xFF01,881,0xFFFF};
...
static const struct desc_info desc_881[] = {
	...
	{EIF_GENERIC(egt_14_881), 13985, 0xFFFFFFFF},
};
void Init881(void)
{
	IDSC(desc_881, 0, 880);
