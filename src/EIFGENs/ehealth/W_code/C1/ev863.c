...
EIF_TYPED_VALUE F863_6986 (EIF_REFERENCE Current)
{
	...
	Result = *(EIF_BOOLEAN *)(Current + RTWA(4913, dtype));
...
void F863_6987 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4913, 0x04000000, 1); /* is_striked_out */
...
void F863_6989 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4914, 0x04000000, 1); /* is_underlined */
...
#define arg1 arg1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4915, 0x10000000, 1); /* vertical_offset */
	*(EIF_INTEGER_32 *)(Current + RTWA(4915, dtype)) = (EIF_INTEGER_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
