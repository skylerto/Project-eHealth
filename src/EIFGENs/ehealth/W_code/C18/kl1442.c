...
extern EIF_TYPED_VALUE F1442_15169(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1442_15169 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1441, Current, 0, 0, 20561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1441, Current, 20561);
	RTIV(Current, RTAL);
	RTHOOK(1);
