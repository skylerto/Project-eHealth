...
extern EIF_TYPED_VALUE F1069_9961(EIF_REFERENCE);
...
RTOID (F1069_9961)
EIF_TYPED_VALUE F1069_9961 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1068, Current, 0, 0, 15638);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 15638);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
