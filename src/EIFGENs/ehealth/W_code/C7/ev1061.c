...
extern EIF_TYPED_VALUE F1061_9808(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1061_9808 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1060, Current, 0, 0, 15345);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1060, Current, 15345);
	RTIV(Current, RTAL);
