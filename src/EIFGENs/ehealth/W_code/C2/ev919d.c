...
static const EIF_TYPE_INDEX egt_1_919 [] = {0xFF01,240,918,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_919 [] = {0xFF01,979,0xFFFF};
static const EIF_TYPE_INDEX egt_14_919 [] = {0xFF01,1096,0xFFFF};
...
static const struct desc_info desc_919[] = {
	...
	{EIF_GENERIC(egt_13_919), 14255, 0},
	{EIF_GENERIC(egt_14_919), 14256, 0xFFFFFFFF},
};
void Init919(void)
{
	IDSC(desc_919, 0, 918);
	IDSC(desc_919 + 1, 1, 918);
	IDSC(desc_919 + 32, 654, 918);
}
