...
extern EIF_TYPED_VALUE F1316_13119(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1316_13119 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1315, Current, 0, 0, 18862);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1315, Current, 18862);
	RTIV(Current, RTAL);
	RTHOOK(1);
