...
extern EIF_TYPED_VALUE F1320_13141(EIF_REFERENCE);
extern void F1320_16344(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1320_13141 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1320_16344 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1319, Current, 0, 16343);
	RTSA(dtype);
	RTME(dtype, 0);
