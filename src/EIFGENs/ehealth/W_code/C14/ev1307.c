...
extern EIF_TYPED_VALUE F1307_13064(EIF_REFERENCE);
static EIF_TYPED_VALUE F1307_13065_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1307_13065(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1307_13064 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1306, Current, 0, 0, 18823);
	RTSA(Dtype(Current));
	RTSC;
...
static EIF_TYPED_VALUE F1307_13065_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1307_13065 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9301, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1307_13065_body (Current)).it_r;
