...
extern EIF_TYPED_VALUE F1233_11861(EIF_REFERENCE);
extern void F1233_11862(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1233_11861 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1233_11862 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1232, Current, 0, 0, 17826);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1232, Current, 17826);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8370, 0xF8000576, 0); /* implementation */
