...
extern EIF_TYPED_VALUE F1098_10201(EIF_REFERENCE);
...
RTOID (F1098_10201)
EIF_TYPED_VALUE F1098_10201 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1097, Current, 0, 0, 16039);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1097, Current, 16039);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
