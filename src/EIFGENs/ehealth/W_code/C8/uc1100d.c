...
static const EIF_TYPE_INDEX egt_1_1100 [] = {0xFF01,240,1099,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_1100 [] = {0xFF01,1137,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1100 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_1100[] = {
	...
	{EIF_GENERIC(egt_13_1100), 16040, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 16041, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1100), -1, 0xFFFFFFFF},
};
void Init1100(void)
{
	IDSC(desc_1100, 0, 1099);
	IDSC(desc_1100 + 1, 1, 1099);
	IDSC(desc_1100 + 32, 539, 1099);
	IDSC(desc_1100 + 33, 978, 1099);
}
