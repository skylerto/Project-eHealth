...
extern EIF_TYPED_VALUE F1099_10202(EIF_REFERENCE);
...
RTOID (F1099_10202)
EIF_TYPED_VALUE F1099_10202 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1098, Current, 0, 0, 16040);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1098, Current, 16040);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
