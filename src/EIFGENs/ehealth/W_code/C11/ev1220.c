...
extern EIF_TYPED_VALUE F1220_11707(EIF_REFERENCE);
extern void F1220_11708(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1220_11707 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1220_11708 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1219, Current, 0, 0, 17672);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1219, Current, 17672);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8370, 0xF8000558, 0); /* implementation */
