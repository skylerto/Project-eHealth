...
extern EIF_TYPED_VALUE F1201_11455(EIF_REFERENCE);
extern void F1201_11456(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1201_11455 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1201_11456 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1200, Current, 0, 0, 17419);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1200, Current, 17419);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8370, 0xF800053D, 0); /* implementation */
