...
extern void F255_3500();
extern void F247_6061();
...
void egc_init_plug (void)
{
	...
	egc_arrmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F255_3500;
	egc_strset = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F221_6333;
	egc_str32set = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F227_6541;
	egc_routdisp_wb = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F247_6061;
	...
	egc_sp_bool = 0x015D;
	egc_sp_uint8 = 0x02C7;
	egc_sp_uint16 = 0x02A6;
	egc_sp_uint32 = 0x0267;
	egc_sp_uint64 = 0x019C;
	egc_sp_int8 = 0x01DC;
	egc_sp_int16 = 0x02EE;
	egc_sp_int32 = 0x0180;
	egc_sp_int64 = 0x0281;
	egc_sp_real32 = 0x022C;
	egc_sp_real64 = 0x0123;
	egc_sp_pointer = 0x01BB;
	egc_sp_ref = 0xF7;
	...
	egc_system_location = "/eecs/home/cse23170/Documents/4312/Project-eHealth/src/EIFGENs/ehealth/W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1441816588;
