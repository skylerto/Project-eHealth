...
extern void F938_16274(EIF_REFERENCE, int);
...
body:;
	...
	RTHOOK(3);
	RTDBGAL(Current, 1, 0xF8000472, 0, 0); /* loc1 */
	ui4_1 = loc2;
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6610, dtype))(Current, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(4);
	ur1 = RTCCL(arg1);
	ui4_1 = ((EIF_INTEGER_32) 1L);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(8196, "fill_from_string", loc1))(loc1, ur1x, ui4_1x);
	RTHOOK(5);
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6613, dtype))(Current)).it_c1);
	uc1 = tc1;
	ui4_1 = (EIF_INTEGER_32) (loc2 - ((EIF_INTEGER_32) 1L));
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6519, "put", loc1))(loc1, uc1x, ui4_1x);
	RTHOOK(6);
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6613, dtype))(Current)).it_c1);
	uc1 = tc1;
	ui4_1 = loc2;
	...
	RTHOOK(7);
	ur1 = RTCCL(loc1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6589, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(8);
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(6598, dtype));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg1, 937, l_feature_name, 1, RTWCT(6591, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		if ((EIF_BOOLEAN) (ti4_1 >= ((EIF_INTEGER_32) 2L))) {
			...
			tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6517, "item", arg1))(arg1, ui4_1x)).it_c1);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6593, 0x10000000, 1); /* capacity */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6518, "count", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 2L));
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6592, 0x10000000, 1); /* count */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype));
	*(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 6591, 0xF8000472, 0); /* content */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6591, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(6);
	RTDBGAA(Current, dtype, 6597, 0x10000000, 1); /* index */
	*(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	RTHOOK(7);
	RTDBGAA(Current, dtype, 6595, 0x10000000, 1); /* line */
	*(EIF_INTEGER_32 *)(Current + RTWA(6595, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	RTHOOK(8);
	RTDBGAA(Current, dtype, 6596, 0x10000000, 1); /* column */
	*(EIF_INTEGER_32 *)(Current + RTWA(6596, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	RTHOOK(9);
	RTDBGAA(Current, dtype, 6594, 0x10000000, 1); /* position */
	*(EIF_INTEGER_32 *)(Current + RTWA(6594, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	RTHOOK(10);
	RTDBGAA(Current, dtype, 6598, 0x04000000, 1); /* beginning_of_line */
	*(EIF_BOOLEAN *)(Current + RTWA(6598, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
		...
		RTCT("capacity_set", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype));
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6518, "count", arg1))(arg1)).it_i4);
...
EIF_TYPED_VALUE F938_8677 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(6597,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F938_8678 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(6598,Dtype(Current)));
	return r;
}
...
body:;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6594, 0x10000000, 1); /* position */
	*(EIF_INTEGER_32 *)(Current + RTWA(6594, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 6595, 0x10000000, 1); /* line */
	*(EIF_INTEGER_32 *)(Current + RTWA(6595, dtype)) = (EIF_INTEGER_32) arg2;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 6596, 0x10000000, 1); /* column */
	*(EIF_INTEGER_32 *)(Current + RTWA(6596, dtype)) = (EIF_INTEGER_32) arg3;
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6597, 0x10000000, 1); /* index */
	*(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype)) = (EIF_INTEGER_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("index_set", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype));
		if ((EIF_BOOLEAN)(ti4_1 == arg1)) {
			RTCK;
		} else {
			RTCF;
...
#define arg1 arg1x.it_b
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6598, 0x04000000, 1); /* beginning_of_line */
	*(EIF_BOOLEAN *)(Current + RTWA(6598, dtype)) = (EIF_BOOLEAN) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
#define arg1 arg1x.it_b
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6603, 0x04000000, 1); /* interactive */
	*(EIF_BOOLEAN *)(Current + RTWA(6603, dtype)) = (EIF_BOOLEAN) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
void F938_8685 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 6602, 0x04000000, 1); /* filled */
	*(EIF_BOOLEAN *)(Current + RTWA(6602, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define uc1 uc1x.it_c1
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6592, 0x10000000, 1); /* count */
	*(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6597, 0x10000000, 1); /* index */
	*(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	RTHOOK(5);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(6598, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(9);
	RTDBGAA(Current, dtype, 6602, 0x04000000, 1); /* filled */
	*(EIF_BOOLEAN *)(Current + RTWA(6602, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F938_8687 (EIF_REFERENCE Current)
{
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6602, 0x04000000, 1); /* filled */
	*(EIF_BOOLEAN *)(Current + RTWA(6602, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
#define ui4_3 ui4_3x.it_i4
	...
	if ((EIF_BOOLEAN)(ti4_1 != ((EIF_INTEGER_32) 1L))) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6521, "move_left", tr1))(tr1, ui4_1x, ui4_2x, ui4_3x);
		RTHOOK(6);
		RTDBGAA(Current, dtype, 6597, 0x10000000, 1); /* index */
		*(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		RTHOOK(7);
		RTDBGAA(Current, dtype, 6592, 0x10000000, 1); /* count */
		*(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype)) = (EIF_INTEGER_32) loc1;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(8);
...
#define ui4_3 ui4_3x.it_i4
	...
	RTHOOK(1);
	RTDBGAL(Current, 2, 0x10000000, 1, 0); /* loc2 */
	loc2 = *(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype));
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype));
	...
	RTHOOK(4);
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
	loc1 = *(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype));
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype));
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype));
	...
	if ((EIF_BOOLEAN)(ti4_1 != loc1)) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6522, "move_right", tr1))(tr1, ui4_1x, ui4_2x, ui4_3x);
		RTHOOK(7);
		RTDBGAA(Current, dtype, 6597, 0x10000000, 1); /* index */
		*(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype)) = (EIF_INTEGER_32) loc1;
		RTHOOK(8);
		RTDBGAA(Current, dtype, 6592, 0x10000000, 1); /* count */
		*(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc2) - ((EIF_INTEGER_32) 1L));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		RTCT("compacted_right", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype));
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype));
		if ((EIF_BOOLEAN)(ti4_1 == ti4_2)) {
			RTCK;
		} else {
			RTCF;
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6518, "count", Result))(Result)).it_i4);
		if ((EIF_BOOLEAN)(ti4_1 == arg1)) {
			RTCK;
		} else {
			RTCF;
...
#define ui4_1 ui4_1x.it_i4
	...
	if ((EIF_BOOLEAN)(ti4_2 == ((EIF_INTEGER_32) 0L))) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6593, 0x10000000, 1); /* capacity */
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6612, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype)) = (EIF_INTEGER_32) ti4_2;
	} else {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 6593, 0x10000000, 1); /* capacity */
		(*(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype))) *= ((EIF_INTEGER_32) 2L);
	}
	RTHOOK(4);
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype));
	...
	RTNHOOK(4,1);
	ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6518, "count", tr2))(tr2)).it_i4);
	if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (ti4_2 + ((EIF_INTEGER_32) 2L)) > ti4_3)) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6523, "resize", tr2))(tr2, ui4_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
...
void F938_16274 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 937, Current, 0, 16273);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6591, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6518, "count", tr1))(tr1)).it_i4);
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype));
	if ((EIF_BOOLEAN) (ti4_1 >= (EIF_INTEGER_32) (ti4_2 + ((EIF_INTEGER_32) 2L)))) {
		RTCK;
	} else {
	...
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype));
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(6592, dtype));
	ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(6593, dtype));
	...
	tc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6613, dtype))(Current)).it_c1);
	...
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype));
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(6597, dtype));
