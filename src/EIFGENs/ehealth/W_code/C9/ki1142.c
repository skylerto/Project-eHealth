...
extern EIF_TYPED_VALUE F1142_10592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1142_10593(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1142_10592 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1141, Current, 0, 0, 16492);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8204, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_TYPED_VALUE F1142_10593 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1141, Current, 0, 1, 16493);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6340, "maximum_byte_code", tr1))(tr1)).it_i4);
