...
extern void F1345_13502(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1345_13503(EIF_REFERENCE);
static EIF_TYPED_VALUE F1345_13504_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1345_13504(EIF_REFERENCE);
...
void F1345_13502 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1344, Current, 0, 1, 19165);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1344, Current, 19165);
	RTCC(arg1, 1344, l_feature_name, 1, RTWCT(9301, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1345_13503 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1344, Current, 0, 0, 19166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1344, Current, 19166);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10330, dtype))(Current)).it_b);
	ub1 = tb1;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9296, 1342))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1345_13504_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1344, Current, 0, 0, 19167);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1344, Current, 19167);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1345_13504 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9301, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1345_13504_body (Current)).it_r;
