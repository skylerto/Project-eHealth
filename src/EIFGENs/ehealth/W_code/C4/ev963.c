...
extern EIF_TYPED_VALUE F963_8836(EIF_REFERENCE);
static EIF_TYPED_VALUE F963_8838_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F963_8838(EIF_REFERENCE);
...
EIF_TYPED_VALUE F963_8836 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6734, 0xF8000448, 0); /* selection_actions_internal */
...
static EIF_TYPED_VALUE F963_8838_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F963_8838 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6734, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F963_8838_body (Current)).it_r;
