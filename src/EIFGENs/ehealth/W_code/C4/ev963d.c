...
static const EIF_TYPE_INDEX egt_1_963 [] = {0xFF01,240,962,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,1096,0xFFFF};
static const EIF_TYPE_INDEX egt_14_963 [] = {0xFF01,1096,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_13_963), 14488, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_963), -1, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0891 /*1096*/), 14489, 0},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 923, 962);
}
