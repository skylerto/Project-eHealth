...
static const EIF_TYPE_INDEX egt_1_980 [] = {0xFF01,240,979,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_980 [] = {0xFF01,1096,0xFFFF};
static const EIF_TYPE_INDEX egt_14_980 [] = {0xFF01,1096,0xFFFF};
...
static const struct desc_info desc_980[] = {
	...
	{EIF_GENERIC(egt_14_980), -1, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0891 /*1096*/), 14520, 0},
};
void Init980(void)
{
	IDSC(desc_980, 0, 979);
