...
feature {NONE} -- Semantic actions
	...
	yy_do_action (yy_act: INTEGER)
		...
		do
				inspect yy_act
when 1 then
--|#line 80 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 80")
end
...
when 2 then
--|#line 87 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 87")
end
...
when 3 then
--|#line 92 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 92")
end
...
when 4 then
--|#line 97 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 97")
end
...
when 5 then
--|#line 104 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 104")
end
...
when 6 then
--|#line 110 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 110")
end
...
when 7 then
--|#line 117 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 117")
end
...
when 9 then
--|#line 122 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
...
when 11 then
--|#line 130 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 130")
end
...
when 12 then
--|#line 136 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 136")
end
...
when 14 then
--|#line 146 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 146")
end
...
when 15 then
--|#line 151 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 151")
end
...
when 16 then
--|#line 156 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 156")
end
...
when 18 then
--|#line 166 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 166")
end
...
when 20 then
--|#line 183 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 183")
end
...
when 21 then
--|#line 190 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 190")
end
...
when 23 then
--|#line 197 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 197")
end
...
when 26 then
--|#line 211 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 211")
end
...
feature {NONE} -- Table templates
	...
	yyr1_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    0,   47,   39,   39,   39,   40,   40,   41,   41,   42,
			   42,   46,   46,   46,   46,   46,   46,   46,   46,   46,
			   43,   44,   44,   44,   45,   45,   45, yyDummy>>)
		end
	...
	yytypes1_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    1,    5,    4,    1,    1,    1,    1,    1,    1,    1,
			    1,    4,    3,    2,    6,    7,    8,    9,    8,    3,
			    2,    1,   10,    8,    1,    1,    8,   10,    1,    1,
			    7,    1,    1,    8,    1,    8,    1,    1,    1, yyDummy>>)
		end
	...
	yydefact_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    2,    1,    4,    0,    0,    0,   24,   12,   11,   14,
			   13,   19,   17,   15,    0,    5,    7,    8,    9,   18,
			   16,   21,    0,   25,    3,    0,   22,    0,   10,    0,
			    6,    0,    0,   26,   20,   23,    0,    0,    0, yyDummy>>)
		end
	...
	yydefgoto_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    1,   14,   15,   16,   17,   27,   22,   18,   36, yyDummy>>)
		end
	...
	yypact_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			 -32768,   40,   14,   -3,   39,    8,    7, -32768, -32768, -32768,
			 -32768, -32768, -32768, -32768,   -6, -32768, -32768, -32768, -32768, -32768,
			 -32768,    2,   12, -32768, -32768,   -3, -32768,    3, -32768,    7,
			 -32768,    5,    2, -32768, -32768, -32768,   32,   21, -32768, yyDummy>>)
		end
	...
	yypgoto_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			 -32768, -32768,   19,   -2, -32768, -32768, -32768,    9, -32768, yyDummy>>)
		end
	...
	yytable_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			   ...
			   13,   12,   11,   10,    9,   23,   25,    8,    7,   26,
			   24,   38,    8,    7,    6,   32,    5,    8,    7,    6,
			   35,    4,   37,   31,   29,   34,    4,   21,   33,    3,
			   28,    4,   20,   19,   30,    2, yyDummy>>)
		end
	...
	yycheck_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    3,    4,    5,    6,    7,    3,    4,    5,    6,    7,
			    3,    4,    5,    6,    7,    6,   22,   20,   21,   21,
			   26,    0,   20,   21,   27,   22,   29,   20,   21,   27,
			   32,   34,    0,   30,   22,   30,   34,   29,   29,   25,
			   28,   34,    3,    4,   25,    5, yyDummy>>)
		end
