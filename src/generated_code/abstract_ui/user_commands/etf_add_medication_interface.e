...
feature {NONE} -- Initialization
	...
	make(an_etf_cmd_name: STRING; etf_cmd_args: TUPLE; an_etf_cmd_container: ETF_ABSTRACT_UI_INTERFACE)
		do
			...
			if
				attached {INTEGER} etf_cmd_args[1] as id and then attached {TUPLE[name: STRING; kind: INTEGER; low: VALUE; hi: VALUE]} etf_cmd_args[2] as medicine
			then
...
feature -- command precondition 
	add_medication_precond(id: INTEGER ; medicine: TUPLE[name: STRING; kind: INTEGER; low: VALUE; hi: VALUE]): BOOLEAN
		do  
			Result := 
